...
let HealthController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('System'), (0, common_1.Controller)('health')];
    ...
    var HealthController = class {
        ...
        static {
            ...
            _checkHealth_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'System Health Check Status' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is active and connected' })];
