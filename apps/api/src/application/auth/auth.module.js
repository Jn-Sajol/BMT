...
const auth_controller_1 = require("../../presentation/auth/auth.controller");
...
const verification_module_1 = require("../verification.module");
const password_reset_module_1 = require("../password-reset.module");
const rbac_module_1 = require("../rbac.module");
...
let AuthModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [
                ...
                {
                    provide: auth_constants_1.AUTH_SERVICE_TOKEN,
                    useClass: auth_service_1.AuthService,
                },
            ],
            exports: [auth_constants_1.AUTH_SERVICE_TOKEN, auth_guard_1.AuthGuard],
        })];
