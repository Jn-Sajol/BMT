...
const campaign_controller_1 = require("../../presentation/campaign/campaign.controller");
const campaign_service_1 = require("../services/campaign.service");
const campaign_validation_service_1 = require("../services/campaign-validation.service");
const campaign_history_service_1 = require("../services/campaign-history.service");
...
let CampaignModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [
                ...
                campaign_history_service_1.CampaignHistoryService,
            ],
            exports: [
                campaign_service_1.CampaignService,
                campaign_history_service_1.CampaignHistoryService,
    ...
    let _classThis;
    var CampaignModule = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            CampaignModule = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
    };
    return CampaignModule = _classThis;
})();
