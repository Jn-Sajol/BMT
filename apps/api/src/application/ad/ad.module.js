...
const ad_controller_1 = require("./presentation/ad.controller");
const ad_service_1 = require("./services/ad.service");
const ad_validation_service_1 = require("./services/ad-validation.service");
const ad_history_service_1 = require("./services/ad-history.service");
...
let AdModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [
                ...
                ad_validation_service_1.AdValidationService,
                ad_history_service_1.AdHistoryService,
            ],
            exports: [
                ad_service_1.AdService,
                ad_history_service_1.AdHistoryService,
    ...
    var AdModule = class {
        ...
        static {
            ...
            AdModule = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
    };
    return AdModule = _classThis;
})();
