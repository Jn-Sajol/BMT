...
@Injectable()
export class MessengerExecutionStrategy implements IExecutionStrategy {
  ...
  public async execute(job: AutomationJob): Promise<{ success: boolean; result?: any }> {
    console.log(`[MessengerExecutionStrategy] Enqueuing Messenger Job ${job.id} to preparation pipeline...`)
