...
export enum AutomationCapability {
  ...
  COMMENT_LINK_MODERATION = "COMMENT_LINK_MODERATION",
  COMMENT_REPLY_ASSISTANT = "COMMENT_REPLY_ASSISTANT",
  COMMENT_AUTO_REPLY = "COMMENT_AUTO_REPLY",
  MESSENGER_INBOX = "MESSENGER_INBOX",
  MESSENGER_MANUAL_REPLY = "MESSENGER_MANUAL_REPLY",
  MESSENGER_AUTO_REPLY = "MESSENGER_AUTO_REPLY",
  MESSENGER_GROUP_ASSISTANT = "MESSENGER_GROUP_ASSISTANT",
  MESSENGER_GROUP_MESSAGE_ENGINE = "MESSENGER_GROUP_MESSAGE_ENGINE",
  GROUP_HUNTER = "GROUP_HUNTER",
}
