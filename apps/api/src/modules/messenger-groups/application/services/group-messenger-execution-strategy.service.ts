...
@Injectable()
export class GroupMessengerExecutionStrategy implements IExecutionStrategy {
  ...
  public async execute(job: AutomationJob): Promise<{ success: boolean; result?: any }> {
    console.log(`[GroupMessengerExecutionStrategy] Enqueuing Group Messenger Job ${job.id} to preparation pipeline...`)
