...
let TemplateAnalyticsService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var TemplateAnalyticsService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            TemplateAnalyticsService = _classThis = _classDescriptor.value;
        ...
        async recordExecution(templateId, isSuccess, executionDurationMs) {
            ...
            const targetId = existing?.id || (0, crypto_1.randomUUID)();
    ...
    return TemplateAnalyticsService = _classThis;
})();
exports.TemplateAnalyticsService = TemplateAnalyticsService;
//# sourceMappingURL=template-analytics.service.js.map