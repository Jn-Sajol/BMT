...
exports.TemplatePublisherService = void 0;
const common_1 = require("@nestjs/common");
const crypto_1 = require("crypto");
let TemplatePublisherService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var TemplatePublisherService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            TemplatePublisherService = _classThis = _classDescriptor.value;
        ...
        async publish(workspaceId, authorId, name, description, canvasJson, visibility = 'COMMUNITY', version = '1.0.0', changelog = 'Initial release') {
            const checksum = (0, crypto_1.createHash)('sha256')
                .update(JSON.stringify(canvasJson || {}))
                .digest('hex');
            const signature = `sig-${(0, crypto_1.randomUUID)()}`;
            ...
            if (existsVer) {
                throw new common_1.BadRequestException(`Version ${version} of template "${name}" already exists.`);
            }
    ...
    return TemplatePublisherService = _classThis;
})();
exports.TemplatePublisherService = TemplatePublisherService;
//# sourceMappingURL=template-publisher.service.js.map