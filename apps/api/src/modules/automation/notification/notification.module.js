...
const template_engine_service_1 = require("./application/services/template-engine.service");
const provider_registry_service_1 = require("./application/services/provider-registry.service");
const notification_preference_service_1 = require("./application/services/notification-preference.service");
const notification_pipeline_service_1 = require("./application/services/notification-pipeline.service");
...
let NotificationModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [
                ...
                notification_pipeline_service_1.NotificationPipelineService,
            ],
            exports: [
                template_engine_service_1.TemplateEngineService,
                provider_registry_service_1.ProviderRegistryService,
