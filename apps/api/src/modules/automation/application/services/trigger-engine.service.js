...
let TriggerEngine = (() => {
    ...
    var TriggerEngine = class {
        ...
        static {
            ...
            TriggerEngine = _classThis = _classDescriptor.value;
        ...
        eventBus;
        prisma;
        logger = new common_1.Logger(TriggerEngine.name);
        constructor(registry, resolver, eventBus, prisma) {
            this.registry = registry;
            this.resolver = resolver;
            this.eventBus = eventBus;
            this.prisma = prisma;
        }
        async processEvent(source, rawPayload, workspaceId, correlationId = (0, crypto_1.randomUUID)(), causationId = (0, crypto_1.randomUUID)()) {
    ...
    return TriggerEngine = _classThis;
})();
exports.TriggerEngine = TriggerEngine;
//# sourceMappingURL=trigger-engine.service.js.map