...
exports.ExecutePasswordResetDto = exports.PasswordResetResponseDto = exports.RequestPasswordResetDto = void 0;
const class_validator_1 = require("class-validator");
let RequestPasswordResetDto = (() => {
    let _email_decorators;
    let _email_initializers = [];
    let _email_extraInitializers = [];
    return class RequestPasswordResetDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _email_decorators = [(0, class_validator_1.IsEmail)({}, { message: 'Invalid email address format' }), (0, class_validator_1.IsNotEmpty)({ message: 'Email address is required' })];
...
let ExecutePasswordResetDto = (() => {
    ...
    return class ExecutePasswordResetDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _token_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Reset token is required' })];
            _newPassword_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'New password is required' }), (0, class_validator_1.MinLength)(8, { message: 'New password must be at least 8 characters long' })];
...
exports.ExecutePasswordResetDto = ExecutePasswordResetDto;
