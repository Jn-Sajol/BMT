...
let CampaignRepository = (() => {
    ...
    var CampaignRepository = class {
        ...
        static {
            ...
            CampaignRepository = _classThis = _classDescriptor.value;
        ...
        async findHistoryByCampaignId(campaignId) {
            try {
        ...
        async findHistoryByCampaignIdAndVersion(campaignId, version) {
            try {
    ...
    return CampaignRepository = _classThis;
})();
