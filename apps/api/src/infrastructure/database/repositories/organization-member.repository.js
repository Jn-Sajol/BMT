...
exports.OrganizationMemberRepository = void 0;
...
let OrganizationMemberRepository = (() => {
    ...
    let _classThis;
    var OrganizationMemberRepository = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            OrganizationMemberRepository = _classThis = _classDescriptor.value;
        ...
        async findByOrgAndUser(orgId, userId) {
            try {
        ...
        async findMembersByOrgId(orgId) {
            try {
    ...
    return OrganizationMemberRepository = _classThis;
})();
exports.OrganizationMemberRepository = OrganizationMemberRepository;
//# sourceMappingURL=organization-member.repository.js.map