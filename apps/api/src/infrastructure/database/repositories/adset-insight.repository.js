...
exports.AdSetInsightRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_error_mapper_1 = require("../prisma-error.mapper");
let AdSetInsightRepository = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var AdSetInsightRepository = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            AdSetInsightRepository = _classThis = _classDescriptor.value;
    ...
    return AdSetInsightRepository = _classThis;
})();
exports.AdSetInsightRepository = AdSetInsightRepository;
//# sourceMappingURL=adset-insight.repository.js.map