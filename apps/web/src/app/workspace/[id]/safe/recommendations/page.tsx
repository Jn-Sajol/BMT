...
import { useRecommendations } from "../../../../../features/safe/recommendations/hooks/useRecommendations"

export default function SafeRecommendationsPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {displayRecommendations.map((rec: any) => (
          <div key={rec.id} className="border bg-card rounded-xl p-6 shadow-sm flex flex-col justify-between md:flex-row md:items-center">
