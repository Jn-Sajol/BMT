...
export function TagManager({ tags, onUpdate }: Props) {
  ...
  const handleUpdate = () => {
    ...
    onUpdate(list)
    alert("Custom classification tags updated!")
  }
  ...
  return (
    <div style={{ color: "#fff", fontFamily: "sans-serif", marginTop: "12px" }}>
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        <input value={inputVal} onChange={(e) => setInputVal(e.target.value)} placeholder="tech, saas, support" style={{ background: "#2d3748", border: "none", color: "#fff", padding: "6px", borderRadius: "4px", flex: 1 }} />
