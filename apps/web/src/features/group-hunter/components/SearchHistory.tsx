...
export function SearchHistory({ history, onSelect }: Props) {
  return (
    <div style={{ color: "#fff", fontFamily: "sans-serif", marginTop: "20px" }}>
      <h4 style={{ color: "#60a5fa", margin: "0 0 10px 0" }}>Recent Search Discovers History</h4>
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        {history.length === 0 && <div style={{ color: "#9ca3af", fontSize: "13px" }}>No group searches performed in this session.</div>}
      </div>
    </div>
  )
}
