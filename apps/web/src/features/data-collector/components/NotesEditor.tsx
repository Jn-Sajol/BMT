...
export function NotesEditor({ initialNotes, onSave }: Props) {
  ...
  return (
    <div style={{ color: "#fff", fontFamily: "sans-serif", marginTop: "12px" }}>
      <label style={{ fontSize: "13px", display: "block", marginBottom: "6px" }}>Leads Notes (SAFE Research):</label>
      <textarea
        value={notes}
        onChange={(e) => setNotes(e.target.value)}
        placeholder="Enter research details, posting times, active niches..."
