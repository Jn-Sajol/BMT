...
export function AutomationReport({ totalRuns, successRuns, failedRuns }: Props) {
  return (
    <div style={{ color: "#fff", fontFamily: "sans-serif", marginTop: "20px", background: "rgba(255,255,255,0.02)", padding: "16px", borderRadius: "8px" }}>
      <h4 style={{ color: "#3b82f6", margin: "0 0 12px 0" }}>Automation Statistics Report</h4>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px", textAlign: "center" }}>
        <div style={{ background: "rgba(255,255,255,0.02)", padding: "8px", borderRadius: "6px" }}>
          ...
          <span style={{ fontSize: "10px", color: "#9ca3af" }}>Total Jobs</span>
        </div>
        <div style={{ background: "rgba(255,255,255,0.02)", padding: "8px", borderRadius: "6px" }}>
