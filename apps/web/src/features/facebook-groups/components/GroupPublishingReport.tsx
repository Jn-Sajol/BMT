...
export function GroupPublishingReport({ reports }: Props) {
  return (
    <div style={{ color: "#fff", fontFamily: "sans-serif", marginTop: "20px" }}>
      <h4 style={{ color: "#60a5fa", margin: "0 0 10px 0" }}>Group Publishing Reports & Audit Log</h4>
      <table style={{ width: "100%", borderCollapse: "collapse", background: "rgba(255,255,255,0.02)" }}>
        ...
        <tbody>
          ...
          {reports.length === 0 && (
            <tr>
              <td colSpan={6} style={{ padding: "8px", textAlign: "center", color: "#9ca3af" }}>No group publishing reports.</td>
            </tr>
          )}
        </tbody>
      </table>
